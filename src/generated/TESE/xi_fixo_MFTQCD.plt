...
set encoding iso
set term post eps enhanced font "Helvetica,15"
set lmargin 10
set grid
...
set output "./MFTQCD_xi_fixo_epsilon_pressure.eps"
...
set title 'MFTQCD, {/Symbol e} {/Symbol \264} P' font ",20"
set xlabel '{/Symbol e} [MeV fm^{-3}]' font ",20"
set ylabel 'Pressure [MeV fm^{-3}]' font ",20"

columns="1:2"

plot "mftqcd_60_0_0075.csv" using @columns ls 1 title "B=60 MeV, {/Symbol x}=0.00075", \
...
set output "./MFTQCD_xi_fixo_pressure_epsilon.eps"
...
set output "./MFTQCD_xi_fixo_mu_pressure.eps"
...
set output "./MFTQCD_xi_fixo_rho_mu.eps"
